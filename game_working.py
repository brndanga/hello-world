...
def remove_punct(text):
    ...
    """
    import string
    #text="Hello!!! mad man. How are you?"
    new_text=""
    #print(text)
    for ch in text :
...
def normalise_input(user_input):
    ...
    'help'
    """
    user_input_nopunct=remove_punct(user_input)
    user_input_nospaces=remove_spaces(user_input_nopunct)
    user_output=user_input_nospaces.lower()
...
def print_menu(exits):
    ...
    """
    print("You can:")
    #for index in exits["exits"] :
    #    print_menu_line(index, (rooms[current_room]["exits"][index]))
...
def menu(exits):
    ...
    while is_valid_exit(current_room, user_input) != True :
        # COMPLETE THIS PART:

        # Display menu
        print_menu(exits)
        # Read player's input
        prop_dest=input("Input direction you wish to go : ")
        # Normalise the input
        user_input=normalise_input(prop_dest)
        #user_input=normalise_input(prop_dest)       
